...
<template>
    <header class="header">
        <svg width="84" height="25" viewBox="0 0 84 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M59.4685 0.52521H63.717L71.7342 18.4524L79.7515 0.52521H84V25H79.8886V9.10364L72.7621 25H70.7064L63.5799 9.10364V25H59.4685V0.52521Z" fill="#101010"/>
        </svg>
        ...
        <nav class="header__menu menu">
            ...
            <button class="menu__button">Let’s work</button>
        </nav>
    </header>
</template>
